...
public class ServerPreferencesFragment extends BasePreferenceFragment implements View.OnTouchListener, Preference.OnPreferenceChangeListener {
    ...
    public void addOtherPreferences() {
        ...
        formListUrlPreference = (EditTextPreference) findPreference(PreferenceKeys.KEY_FORMLIST_URL);
        submissionUrlPreference = (EditTextPreference) findPreference(PreferenceKeys.KEY_SUBMISSION_URL);
